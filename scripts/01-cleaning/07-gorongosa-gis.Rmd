...
pans.raster <- raster("gis/Rasters for stacking/Masked rasters/pans.raster.tif")
...
panslarge.raster <- raster("gis/Spatial data/Pan_conservative/panslarge.raster.tif")
...
writeRaster(panscon_100m_res, 'gis/Rasters for stacking/Focal rasters/panscon_100m_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
writeRaster(panscon_250m_res, 'gis/Rasters for stacking/Focal rasters/panscon_250m_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
writeRaster(panscon_500m_res, 'gis/Rasters for stacking/Focal rasters/panscon_500m_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
writeRaster(panscon_1km_res, 'gis/Rasters for stacking/Focal rasters/panscon_1km_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
writeRaster(panslarge_100m_res, 'gis/Rasters for stacking/Focal rasters/panslarge_100m_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
...
writeRaster(panslarge.crop.500m_res, 'gis/Rasters for stacking/Focal rasters/panslarge.crop.500m_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
writeRaster(panslarge.crop.1km_res, 'gis/Rasters for stacking/Focal rasters/panslarge.crop.1km_res.tif', format="GTiff", overwrite=TRUE, options=c("INTERLEAVE=BAND","COMPRESS=LZW"))
```
