...
D.aerial2017 <- read.csv("Data/Cleaned_occupancy_records/Detections_9_1_17_11_30_17.csv")
```
...
Camop.aerial2017 <- read.csv("Data/Cleaned_occupancy_records/Camoperation_9_1_17_11_30_17.csv")
...
Camop.aerial2017 <- Camop.aerial2017[Camop.aerial2017$Operation >9,]
```
...
```{r import other data}
LOC <- read.csv(here::here("data", "2018camloc.csv")) # Camera locations (latitude and longitude, here Southing and Easting)
Spp <- read.csv(here::here("data", "2018spp_kingdon.csv")) # Species IDs and traits
# specify LMH Species
Spp.lmh <- Spp[Spp$LMH == "yes",]

Covariates <- read.csv(here::here("data", "cam_metadata_norm_031519.csv"))
...
out3 <- jags(data = data, 
             inits = inits, 
             parameters.to.save = params, 
             model.file ="scripts/04-occupancy-analysis/AllMammals_pcov_nogroup.txt", 
             n.chains = nc, 
             n.iter = ni,
             n.burnin = nb, 
             n.thin = nthin)
...
##### Aerial count period 2017 (well, the equivalent period)

###### basic summary stats

```{r summmarize aerial}
# calculate total number of detections of each species during study period
D.aerial2017.sums <- colSums(D.aerial2017[,2:ncol(D.aerial2017)])
names(D.aerial2017.sums) <- names(D.aerial2017[,2:ncol(D.aerial2017)]) 

# calculate number of cameras at which each species was detected
apply(D.aerial2017, 2, function(c)sum(c!=0))
(apply(D.aerial2017, 2, function(c)sum(c!=0)) / 60 )*100 # as percentage
```
...
out3 <- jags(data = data, 
             inits = inits, 
             parameters.to.save = params, 
             model.file ="scripts/04-occupancy-analysis/AllMammals_pcov.txt", 
             n.chains = nc, 
             n.iter = ni,
             n.burnin = nb, 
             n.thin = nthin)
...
write.table(x=out3.sum,file="results/Occupancy/Aerial2017_bysize/Aerial2017.csv",sep=",") # save output
...
names(psimeans) <- sppnames2
psimeans <- as.data.frame(psimeans)
write.table(x = psimeans, file = "Results/Occupancy/Aerial2017_bysize/Aerial2017_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "Results/Occupancy/Aerial2017_bysize/Aerial2017_detection.csv", sep=",")
...
psiCI <- apply(logit.alpha, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(psiCI) <- sppnames2
write.table(x=psiCI, file="Results/Occupancy/Aerial2017_bysize/Aerial2017_alphaCI.psi()p().csv",sep=",")

apply(logit.p, 2, function(x) sort(x)[])
pCI <- apply(logit.p, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(pCI) <- sppnames2
write.table(x = pCI, file="Results/Occupancy/Aerial_bysize/Aerial2017_pCI.psi()p().csv", sep = ",")
...
# Export table with group values.
write.table(x = group, file = "Results/Occupancy/Aerial2017_bysize/Aerial2017_group.csv", sep = ",", row.names=F)
...
# export the table
write.table(x=species,file="Results/Occupancy/Aerial2017_bysize/Aerial2017_species.csv",sep=",", row.names=F) 
...
# Export estimates of species richness as a table
write.table(x=z.all,file="Results/Occupancy/Aerial2017_bysize/Aerial2017_spprich.csv",sep=",")
...
# Export estimates of group richness as a table
write.table(x=z.group,file="Results/Occupancy/Aerial2017_bysize/Aerial2017_grouprich.csv",sep=",")
```
...
write.table(x=out3.sum,file="Results/Occupancy/Aerial2017_bydiet/Aerial2017.csv",sep=",") # save output
...
names(psimeans) <- sppnames2
psimeans <- as.data.frame(psimeans)
write.table(x = psimeans, file = "Results/Occupancy/Aerial2017_bydiet/Aerial2017_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "Results/Occupancy/Aerial2017_bydiet/Aerial2017_detection.csv", sep=",")
...
psiCI <- apply(logit.alpha, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(psiCI) <- sppnames2
write.table(x=psiCI, file="Results/Occupancy/Aerial2017_bydiet/Aerial2017_alphaCI.psi()p().csv",sep=",")

apply(logit.p, 2, function(x) sort(x)[])
pCI <- apply(logit.p, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(pCI) <- sppnames2
write.table(x = pCI, file="Results/Occupancy/Aerial2017_bydiet/Aerial2017_pCI.psi()p().csv", sep = ",")
...
# Export table with group values.
write.table(x = group, file = "Results/Occupancy/Aerial2017_bydiet/Aerial2017_group.csv", sep = ",", row.names=F)
...
# export the table
write.table(x=species,file="Results/Occupancy/Aerial2017_bydiet/Aerial2017_species.csv",sep=",", row.names=F) 
...
# Export estimates of species richness as a table
write.table(x=z.all,file="Results/Occupancy/Aerial2017_bydiet/Aerial2017_spprich.csv",sep=",")
...
# Export estimates of group richness as a table
write.table(x=z.group,file="Results/Occupancy/Aerial2017_bydiet/Aerial2017_grouprich.csv",sep=",")
```
...
write.table(x=out3.sum,file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017.csv",sep=",") # save output
...
names(psimeans) <- sppnames2
psimeans <- as.data.frame(psimeans)
write.table(x = psimeans, file = "Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_detection.csv", sep=",")
...
psiCI <- apply(logit.alpha, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(psiCI) <- sppnames2
write.table(x=psiCI, file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_alphaCI.psi()p().csv",sep=",")

apply(logit.p, 2, function(x) sort(x)[])
pCI <- apply(logit.p, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(pCI) <- sppnames2
write.table(x = pCI, file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_pCI.psi()p().csv", sep = ",")
...
# Export table with group values.
write.table(x = group, file = "Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_group.csv", sep = ",", row.names=F)
...
# export the table
write.table(x=species,file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_species.csv",sep=",", row.names=F) 
...
# Export estimates of species richness as a table
write.table(x=z.all,file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_spprich.csv",sep=",")
...
# Export estimates of group richness as a table
write.table(x=z.group,file="Results/Occupancy/Aerial2017_byfunctionalgrp/Aerial2017_grouprich.csv",sep=",")
```
...
write.table(x=out3.sum,file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017.csv",sep=",") # save output
...
names(psimeans) <- sppnames2
psimeans <- as.data.frame(psimeans)
write.table(x = psimeans, file = "Results/Occupancy/Aerial2017_bydiet2/Aerial2017_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "Results/Occupancy/Aerial2017_bydiet2/Aerial2017_detection.csv", sep=",")
...
psiCI <- apply(logit.alpha, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(psiCI) <- sppnames2
write.table(x=psiCI, file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017_alphaCI.psi()p().csv",sep=",")

apply(logit.p, 2, function(x) sort(x)[])
pCI <- apply(logit.p, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(pCI) <- sppnames2
write.table(x = pCI, file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017_pCI.psi()p().csv", sep = ",")
...
# Export table with group values.
write.table(x = group, file = "Results/Occupancy/Aerial2017_bydiet2/Aerial2017_group.csv", sep = ",", row.names=F)
...
# export the table
write.table(x=species,file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017_species.csv",sep=",", row.names=F) 
...
# Export estimates of species richness as a table
write.table(x=z.all,file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017_spprich.csv",sep=",")
...
# Export estimates of group richness as a table
write.table(x=z.group,file="Results/Occupancy/Aerial2017_bydiet2/Aerial2017_grouprich.csv",sep=",")
```
...
write.table(x=out3.sum,file="Results/Occupancy/Aerial2017_nogroup/Aerial2017.csv",sep=",") # save output
...
names(psimeans) <- sppnames2
psimeans <- as.data.frame(psimeans)
write.table(x = psimeans, file = "Results/Occupancy/Aerial2017_nogroup/Aerial2017_alphaspsi()p().csv", sep = ",")

pmeans <- colMeans(logit.p)
names(pmeans) <- sppnames2
write.table(x = pmeans, file = "Results/Occupancy/Aerial2017_nogroup/Aerial2017_detection.csv", sep=",")
...
psiCI <- apply(logit.alpha, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(psiCI) <- sppnames2
write.table(x=psiCI, file="Results/Occupancy/Aerial2017_nogroup/Aerial2017_alphaCI.psi()p().csv",sep=",")

apply(logit.p, 2, function(x) sort(x)[])
pCI <- apply(logit.p, 2, function(x) quantile(x,probs = c(0.025,0.1,0.5,0.9,0.975)))
colnames(pCI) <- sppnames2
write.table(x = pCI, file="Results/Occupancy/Aerial2017_nogroup/Aerial2017_pCI.psi()p().csv", sep = ",")
...
# export the table
write.table(x=species,file="Results/Occupancy/Aerial2017_nogroup/Aerial2017_species.csv",sep=",", row.names=F) 
...
# Export estimates of species richness as a table
write.table(x=z.all,file="Results/Occupancy/Aerial2017_nogroup/Aerial2017_spprich.csv",sep=",")
