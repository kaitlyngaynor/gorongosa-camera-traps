## this version uses the 10-minute record tables, rather than the 15-minute ones
...
record.table.year1 <- read.csv("Gaynor_10minrecords_June2016_to_June2017.csv", stringsAsFactors = FALSE)
record.table.year2 <- read.csv("R/Data/Raw Data/recordtable_year2_10min.csv", stringsAsFactors = FALSE)
...
# export
write.csv(record.table, "R/Data/Raw Data/recordtable_year1and2_10min.csv", row.names=F)
...
record.table <- read.csv("R/Data/Raw Data/recordtable_year1and2_10min.csv")
...
# WET 3MO YEAR 1 ONLY: we have to add multiple columns (missing 3 species)
...
# write csv
write.csv(RAI.table, "R/Results/RAI/RAI10min_dry_year1.csv", row.names=F)
write.csv(RAI.table, "R/Results/RAI/RAI10min_wet3mo_year1.csv", row.names=F)
write.csv(RAI.table, "R/Results/RAI/RAI10min_wet4mo_year1.csv", row.names=F)
write.csv(RAI.table, "R/Results/RAI/RAI10min_dry_year2.csv", row.names=F)
write.csv(RAI.table, "R/Results/RAI/RAI10min_wet3mo_year2.csv", row.names=F)
write.csv(RAI.table, "R/Results/RAI/RAI10min_wet4mo_year2.csv", row.names=F)
